...
public class KafkaBookProducerTestContainer {

    private static final Logger LOGGER = LoggerFactory.getLogger(KafkaBookProducerTestContainer.class);
    ...
    private KafkaMessageListenerContainer<String, Book> container;

    private BlockingQueue<ConsumerRecord<String, Book>> records;
    ...
    public void setUp() throws Exception {
        ...
        ContainerProperties containerProperties = new ContainerProperties(senderTopic);

        // create a Kafka MessageListenerContainer
        container = new KafkaMessageListenerContainer<String, Book>(consumerFactory, containerProperties);

        // create a thread safe queue to store the received message
        records = new LinkedBlockingQueue<>();

        // setup a Kafka message listener
        container.setupMessageListener(new MessageListener<String, Book>() {
            @Override
            public void onMessage(
                    ConsumerRecord<String, Book> record) {
    ...
    public void testSend() throws InterruptedException {
        ...
        ConsumerRecord<String, Book> received =
